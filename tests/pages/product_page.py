...
class ProductPage:
    ...
    def get_product_details(self):
        ...
        prod_desc = self.driver.find_element(
            By.CSS_SELECTOR, "div[id='tbodyid'] div[id='more-information'] p"
        )
        prod_price = self.driver.find_element(
            By.CSS_SELECTOR, "div[id='tbodyid'] h3[class='price-container']"
        )
